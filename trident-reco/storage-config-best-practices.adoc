...
資料區塊大小和頻寬直接影響 IOPS 值。隨著資料區塊大小的增加，系統會提升頻寬以處理更大的資料區塊。頻寬增加的同時，系統能夠達到的 IOPS 值反而會下降。如需有關 QoS 和效能的詳細資訊，請參閱 https://www.netapp.com/pdf.html?item=/media/10502-tr-4644.pdf["服務品質SolidFire"^]。
