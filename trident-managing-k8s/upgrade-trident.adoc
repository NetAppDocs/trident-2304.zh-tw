...
`tridentctl` 是安裝 Astra Trident 的傳統方法，為需要複雜自訂的使用者提供最多選項。如需更多詳細資訊，請參閱 link:../trident-get-started/kubernetes-deploy.html#choose-your-installation-method["選擇您的安裝方法"]。
